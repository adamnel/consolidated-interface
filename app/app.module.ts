...
@NgModule({
  ...
  declarations: [
    ...
    ObjectsCodeComponent,
    ObjectsHistoryComponent,
    ObjectsInfoComponent,
    ObjectsPermissionsComponent,
    ObjectsScheduleComponent,
    ObjectsVersionsComponent,
    EnginesComponent,
    EnginesListComponent,
    EnginesDetailsComponent,
    EnginesCodeComponent,
    EnginesHistoryComponent,
    EnginesInfoComponent,
    EnginesPermissionsComponent,
    EnginesScheduleComponent,
    EnginesVersionsComponent,
    MonitoringComponent,
